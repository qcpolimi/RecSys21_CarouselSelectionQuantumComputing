...
def runHyperparameterSearch_Collaborative(recommender_class, URM_train, URM_train_last_test = None,
    ...
    try:
       ...
       ##########################################################################################################
        ...
        #         "p_dims": Categorical([None]),
        #     }
        #
        #     # if "dl_layers" in kwargs:
        #     #     for i in range(dl_layers):
        #     #         hyperparameters_range_dictionary["dl_layer_{}".format(i)] = Categorical([64, 128, 256, 512, 1024])
        #
        #     recommender_input_args = SearchInputRecommenderArgs(
        #         CONSTRUCTOR_POSITIONAL_ARGS = [URM_train],
        #         CONSTRUCTOR_KEYWORD_ARGS = {},
